...
timestamp = (data[:, 0] - 1668797893742)/100
...
# accelerometer1 = numpy.genfromtxt("acceleration.csv", delimiter=",", skip_header=0)
# timestamp = accelerometer1[:, 0]
# accelerometer = accelerometer1[:, 1:4]
# gyroscope1 = numpy.genfromtxt("gyroscope.csv", delimiter=",", skip_header=0)
# timestamp_g = gyroscope1[:,0]
# gyroscope = gyroscope1[:, 1:4]

# print(accelerometer1[0],gyroscope)
...
if True:
    ...
    # anim.save("animation.mp4", writer=animation.FFMpegWriter(fps) )
